...
public class PokemonRepositoryTest {
    ...
    public void PokemonRepository_FindByType_ReturnPokemonNotNull() {
        ...
        Assertions.assertThat(existPokemon.getType()).isEqualTo(PokemonType.ELECTRIC);
        Assertions.assertThat(existPokemon.getType().name()).isEqualTo(PokemonType.ELECTRIC.name());

        System.out.println(existPokemon.getType() + " = " + PokemonType.ELECTRIC.name());
    }
